...
---
This message was sent from the KFT website contact form.
      `.trim()

      const mailtoLink = `mailto:khegarha.falahi.tanzeem@gmail.com?subject=${encodeURIComponent(
        subject,
        ...
        <Card className="max-w-md mx-auto shadow-lg">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Thank you for contacting us. Your email client should have opened with your message. We'll get back to you
              within 24 hours.
            </p>
